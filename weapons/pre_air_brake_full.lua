...
DestroyProjectile = "plank_killer"
BarrelLength = 60.0
MinFireClearance = 0
...
{
	{
  	Name = "pre_air_brake_full",
		States =
		{
			Normal = { Frames = { { texture = path .. "/weapons/air_brake_full/air_brake_full.tga" }, mipmap = true, }, },
		},
	},
}
